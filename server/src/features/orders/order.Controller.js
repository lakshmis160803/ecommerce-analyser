...
// Group customers from uploaded orders
...
for (const order of orders) {
  ...
  if (!customerMap.has(customerName)) {
    ...
    customer.totalQuantity += Number(order.quantity || 0);
...
// Save all customers (create new, or merge into existing ones)
