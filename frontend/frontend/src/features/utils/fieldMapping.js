...
// ✅ Decide whether a row looks like an "order" row or a "product" row.
// Strategy: count how many columns match each alias set, and pick whichever
// schema has more matches. Order files are distinguished mainly by having
// orderId / customerName / quantity / orderDate columns that product files
// don't have.
